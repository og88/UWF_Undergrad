...
generate_attach_a_constraint_1_1(A/B, C) :-
	...
	I=..[D|E],
	J=..[D, G, H],
	generate_attach_body_1(A/B, F, H, K),
	L= (K, J),
	C= (I:-L).
...
generate_attach_a_constraint_t_p(A/B, C) :-
	...
	I=..[D|E],
	J=..[D, G, H],
	generate_attach_body_n(A/B, F, H, K),
	L= (K, J),
	C= (I:-L).
...
generate_detach_a_constraint_1_1(A/B, C) :-
	...
	I=..[D|E],
	J=..[D, G, H],
	generate_detach_body_1(A/B, F, H, K),
	L= (K, J),
	C= (I:-L).
...
generate_detach_a_constraint_t_p(A/B, C) :-
	...
	I=..[D|E],
	J=..[D, G, H],
	generate_detach_body_n(A/B, F, H, K),
	L= (K, J),
	C= (I:-L).
...
generate_attr_unify_hook([A]) :-
	...
	(   B==0
	->  get_target_module(C),
	    A= (attr_unify_hool(D, E):-write('ERROR: Unexpected triggering of attr_unify_hook/2 in module '), writeln(C))
	;   B==1
...
generate_insert_constraint(A, B, C) :-
	B=D/E,
	atom_concat_list(['$insert_in_store_', D, /, E], F),
	G=..[F, H],
	generate_insert_constraint_body(A, B, H, I),
	C= (G:-I).
...
generate_delete_constraint(A, B/C, D) :-
	atom_concat_list(['$delete_from_store_', B, /, C], E),
	F=..[E, G],
	generate_delete_constraint_body(A, B/C, G, H),
	D= (F:-H).
...
generate_delete_constraint_call(A/B, C, D) :-
	atom_concat_list(['$delete_from_store_', A, /, B], E),
	D=..[E, C].
generate_insert_constraint_call(A/B, C, D) :-
	atom_concat_list(['$insert_in_store_', A, /, B], E),
	D=..[E, C].
...
check_attachment(A) :-
	A=pragma(B, ids(C, D), E, F, G),
	B=rule(H, I, J, K),
	check_attachment_heads1(H, C, G, H, I, J),
	check_attachment_heads2(I, D, G, H, K).
check_attachment_heads1([], A, B, C, D, E).
check_attachment_heads1([A|B], [C|D], E, F, G, H) :-
	functor(A, I, J),
	(   F==[A],
	    G==[],
	    H==true,
	...
	check_attachment_heads1(B, D, E, F, G, H).
no_matching([], A).
no_matching([A|B], C) :-
	var(A),
	\+memberchk_eq(A, C),
...
check_attachment_heads2([A|B], [C|D], E, F, G) :-
	functor(A, H, I),
	(   is_passive(E, C)
	->  attached(H/I, maybe)
	;   F\==[],
	...
	check_attachment_heads2(B, D, E, F, G).
all_attached([]).
all_attached([A|B]) :-
	functor(A, C, D),
	is_attached(C/D),
...
gen_uncond_attach_goal(A/B, C, D, E) :-
	...
	generate_insert_constraint_call(A/B, C, I),
	D= (activate_constraint(J, H, C, E), (J==yes->I, G;true)).
...
gen_uncond_susp_detachment(A, B/C, D) :-
	...
	->  (   may_trigger(B/C)
	    ...
	    generate_delete_constraint_call(B/C, A, I),
	    D= (H, remove_constraint_internal(A, G, J), (J==yes->I, F;true))
	;   D=true
	).
...
'attached/2__2'(A, B, C) :-
	B==maybe,
	'$via1_multi_hash_attached/2-1'(A, D), !,
	'attached/2__2__0'(D, A, B, C).
'attached/2__2__0'([], A, B, C) :-
	'attached/2__3'(A, B, C).
'attached/2__2__0'([A|B], C, D, E) :-
	(   A=suspension(F, G, H, I, J, K, L, M),
	    G=mutable(active),
	    L==C,
	    M==maybe
...
'indexed_argument/2__0'(A, B, C) :-
	...
	'indexed_argument/2__0__0'(D, A, B, C).
'indexed_argument/2__0__0'([], A, B, C) :-
	'indexed_argument/2__1'(A, B, C).
'indexed_argument/2__0__0'([A|B], C, D, E) :-
	(   A=suspension(F, G, H, I, J, K, L, M),
	    G=mutable(active),
	    L==C,
	    M==D
	->  remove_constraint_internal(A, N, O),
	    ...
	    'indexed_argument/2__0__0'(B, C, D, E)
	;   'indexed_argument/2__0__0'(B, C, D, E)
	).
'indexed_argument/2__0'(A, B, C) :-
	allocate_constraint(chr_translate:'indexed_argument/2__0'(A, B, C), C, indexed_argument(A, B), [A, B]),
...
passive(A, B) :-
	'passive/2__0'(A, B, C).
'passive/2__0'(A, B, C) :-
	insert_constraint_internal(D, E, C, chr_translate:'passive/2__0'(A, B, C), passive(A, B), [A, B]),
