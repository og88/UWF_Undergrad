...
index((xref_source), 1, pce_xref, pce_prolog_xref).
index((xref_called), 2, pce_xref, pce_prolog_xref).
index((xref_called), 3, pce_xref, pce_prolog_xref).
index((xref_defined), 3, pce_xref, pce_prolog_xref).
index((xref_exported), 2, pce_xref, pce_prolog_xref).
index((xref_module), 2, pce_xref, pce_prolog_xref).
index((xref_clean), 1, pce_xref, pce_prolog_xref).
index((xref_current_source), 1, pce_xref, pce_prolog_xref).
index((xref_built_in), 1, pce_xref, pce_prolog_xref).
index((xref_expand), 2, pce_xref, pce_prolog_xref).
index((xref_source_file), 3, pce_xref, pce_prolog_xref).
index((xref_public_list), 4, pce_xref, pce_prolog_xref).
index((xref_meta), 2, pce_xref, pce_prolog_xref).
index((xref_used_class), 2, pce_xref, pce_prolog_xref).
index((xref_defined_class), 3, pce_xref, pce_prolog_xref).
